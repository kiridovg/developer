...
/* harmony import */ var _components_Blog_Post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Blog/Post */ "./resources/js/components/Blog/Post.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    Post: _components_Blog_Post__WEBPACK_IMPORTED_MODULE_1__.default
  },
  data: function data() {
    return {
      align: 'center',
  ...
  methods: {
    loadPosts: function loadPosts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/books?page=' + page).then(function (res) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    store: function store() {
      ...
      this.loading = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/books', this.form, {
        headers: {
          "Content-type": "application/json"
        }
      }).then(function (res) {
        if (res.data.status) {
          _this.$router.push('/post/' + res.data.post.id);
        } else {
          setTimeout(function () {
            _this.loading = false;
          }, 300);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadPost: function loadPost(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get('/api/books/' + id).then(function (res) {
        _this.post = res.data;
        setTimeout(function () {
          _this.loading = false;
        }, 500);
...
vue__WEBPACK_IMPORTED_MODULE_0__.default.component('v-header', __webpack_require__(/*! ./components/Header.vue */ "./resources/js/components/Header.vue").default);
...
var apps = new vue__WEBPACK_IMPORTED_MODULE_0__.default({
  el: '#apps',
...
/* harmony import */ var _views_CreatePost__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/CreatePost */ "./resources/js/views/CreatePost.vue");
...
var routes = [{
  ...
  path: "/create",
  component: _views_CreatePost__WEBPACK_IMPORTED_MODULE_5__.default
}];
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "card mx-auto mt-3 mb-3 d-flex flex-column",
    ...
    [
      _c("img", {
        ...
        attrs: {
          src: "https://99px.ru/sstorage/53/2014/05/tmb_102421_3124.jpg",
          alt: ""
        }
      }),
      _vm._v(" "),
      _c("div", { staticClass: "card-body d-flex flex-column" }, [
        ...
        _c(
          "a",
          { staticClass: "btn btn-primary mt-auto", attrs: { href: "#" } },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("nav", { staticClass: "uk-navbar-container" }, [
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("pagination", {
        attrs: { align: _vm.align, data: _vm.books },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm.not_found
        ? _c("div", [
            _c("a", { staticClass: "uk-alert-close" }),
            _vm._v(" "),
...
/******/ 	__webpack_require__.O(undefined, ["css/apps"], () => (__webpack_require__("./resources/js/apps.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/apps"], () => (__webpack_require__("./resources/css/apps.css")))
